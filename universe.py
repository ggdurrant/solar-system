...
class Universe:
    ...
    def __init__(self, num_planets):
        for i in range(num_planets):
            self.planets.append(Planet(random.randint(10, WIDTH-10), random.randint(10, HEIGHT-10), 1))
        self.sun = Planet(WIDTH/2, HEIGHT/2, 10, m=50*DENSITY, c=YELLOW)
    ...
    def update_gravity(self):
        ...
        #         local_gravity = G*body.mass*planet.mass/(local_dist**2)
        #         planet.vel = planet.vel+planet.vel*local_gravity
